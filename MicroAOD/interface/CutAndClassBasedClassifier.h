...
namespace flashgg {
    ...
    public:
        ...
        std::pair< std::pair<std::string, std::string >, int> operator()( const T &obj ) const
        {
            ...
            int counter = 0;
            std::cout << " DEBUG mass " <<  obj.diPhoton()->mass() << ", systLabel " << obj.systLabel() << ", centralWeight " << obj.centralWeight() << std::endl;
            for( auto &cut : cuts_ ) {
                if( cut.first( obj ) ) {
            ...
            std::cout << " DEBUG mass (v2)" <<  obj.diPhoton()->mass() << ", systLabel " << obj.systLabel() << ", centralWeight " << obj.centralWeight() << std::endl;
            return res;
